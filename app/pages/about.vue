...
const leaders = [
  ...
  },
  {
    ...
    instagram: 'tomas.klein08',
    linkedin: 'tomáš-klein-4818293a0',
  },
  {
    img: '/components/leaders/adam.jpg',
    name: 'Adam Dacho',
    role: t('roles.executiveBoardViceChair'),
    instagram: 'adam.dacho',
    linkedin: 'adam-d-4b98b6290',
  },
  {
    img: '/components/leaders/durica.png',
    name: 'Sebastián Durica',
  ...
  },
  {
    ...
    role: t('roles.contentWritersLeader'),
  ...
  },
  {
    ...
    name: 'Martin Šenkýř',
    role: t('roles.chiefTechnicalOfficer'),
