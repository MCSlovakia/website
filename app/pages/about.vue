<template>
   ...
   const leaders = [
  {
    ...
    instagram: '',
    linkedin: '',
  },3xl text-2xl">{{ t('about.hero.title') }}</h1>
...
const leaders = [
  ...
  },
  {
    ...
    name: 'Tomáš Klein ml.',
    role: t('roles.executiveBoardChairJunior'),
    instagram: '',
    linkedin: '',
  },
  {
  ...
  },
  {
    img: '/components/leaders/holder.png',
    name: 'Martin Šenkýř',
    role: t('roles.itLeader'),
    instagram: '',
    linkedin: '',
  },
  {
    img: '/components/leaders/balabolkin.png',
    name: 'Peter Balabolkin',
